...
public static class DatabaseExtensions
{
    ...
    public static async Task ApplyMigrationsAsync(this WebApplication app) // this делает метод расширением для типа WebApplication
    {
        ...
        try
        {
            await dbContext.Database.MigrateAsync(); // Применить все миграции к базе данных
